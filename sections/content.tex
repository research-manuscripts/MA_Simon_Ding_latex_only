...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{Monkey-Testing}
            \addplot[name path=monkey_top,color=green!70] table [x=x,y=above,col sep=comma] {experimental_data/monkey/results.csv};
            \addplot[name path=monkey_bottom,color=green!70] table [x=x,y=below,col sep=comma] {experimental_data/monkey/results.csv};
            \addplot[green!50,fill opacity=0.5] fill between[of=monkey_top and monkey_bottom];
        \end{axis}
    \end{tikzpicture}
