...
\todo{linguistische Datenverarbeitung groß kleinschreiben}
...
\todo{Das hier genauer, vllt. über Benutztererfahrung? Startseite -> Produktliste -> Warenkorb -> Kasse -> Bestellbestätigung}
...
\begin{enumerate}
    ...
    \item \todo{Bindestriche?} Chain of Thought Eingaben: Das erwartete Format für die Ausgabe des LLM enthält einen kompletten erklärenden Gedankengang. Im Gegensatz zum Ansatz 5 werden dazu Beispiele im Prompt geliefert \cite{chain-of-thought}.\todo{Das ist sehr unklar}
\end{enumerate}

\section{Validierung}
\label{sec:vaildation}

\todo{erklärung der Branchenabdeckung (oder in Grundlagen damit?) und warum Monkey-Testing}
