...
\textit{Dieses Exposé besteht aus minimal angepassten Ausschnitten einer unfertigen Masterarbeit unter gleichem Titel.}
...
Zweitens wird gezeigt, dass das LLM gleichzeitig als Testorakel verwendet werden kann, das heißt, dass das LLM auch in der Lage ist, Fehlerzustände zu erkennen.

Kapitel \ref{ch:Conclusion} schließt, dass sich damit sowohl das Problem der Flakiness eingrenzen, als auch die Wartung der Tests vereinfachen lassen.
Zudem wird die Frage aufgeworfen, inwieweit dieses Ergebnis auf die Praxis übertragbar ist und wann der Ansatz wirtschaftlich ist.
