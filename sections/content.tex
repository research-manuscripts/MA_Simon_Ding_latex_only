...
In Kapiteln \ref{ch:ExperimentalSetup} und \ref{ch:Results} wird dieser Ansatz an einer komplexeren Webanwendung mit verschiedenen Möglichkeiten zur Interaktion getestet.
