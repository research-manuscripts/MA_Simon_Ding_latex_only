...
\begin{enumerate}
    ...
    \item Beschreibung: Zusätzlich zur Verkettung wird das LLM aufgefordert eine Beschreibung des Anwendungszustands zu generieren. Diese wird dann mit verkettet.
\end{enumerate}
